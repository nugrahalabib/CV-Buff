...
const SEO_BASE_URL = "https://cv.agentbuff.id";
...
function getLocaleSeo(locale: Locale) {
  ...
  const localeTag = locale === "en" ? "en_US" : "id_ID";
  ...
  head: ({ params }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:site_name", content: "CV-Buff" },
      ...
      links: [
        ...
        { rel: "alternate", hrefLang: "x-default", href: `${SEO_BASE_URL}/id` }
      ]
    };
  },
