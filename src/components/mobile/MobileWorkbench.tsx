  ...
  return (
    <div className="flex flex-col h-[calc(100vh-64px)] bg-background">
      ...
      <div className="h-16 border-t bg-background flex items-center justify-around relative shadow-[0_-1px_3px_rgba(0,0,0,0.05)] z-50">
        {renderNavItem("content", <FileText className="w-5 h-5" />, "Konten")}
        {renderNavItem("style", <Palette className="w-5 h-5" />, "Gaya")}
        {renderNavItem("preview", <Eye className="w-5 h-5" />, "Pratinjau")}
      </div>
    </div>
  );
}
