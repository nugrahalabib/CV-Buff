...
const SEPARATOR = " - ";
const PRESENT_VALUES = new Set(["Sekarang", "Present", "Now"]);
...
export function UnifiedDateRangeInput({
  ...
  const isPresent = value.includes("Sekarang") || value.includes("Present");
  ...
  const updateValue = (
    ...
    const endStr = isPresent ? (value.includes("Sekarang") ? "Sekarang" : "Present") : (newEnd ? format(newEnd) : "");
