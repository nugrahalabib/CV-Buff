...
export default function AIPolishDialog({
  ...
  const getActive = useAIConfigStore((s) => s.getActive);
    ...
    try {
      ...
      if (!rawText) {
        if (response.status === 401) {
          return "Autentikasi gagal (401). Periksa API Key, model, dan Endpoint provider Anda.";
        }
        return fallback;
      }
      ...
      // ignore parse errors, fall through to default messages
    }
