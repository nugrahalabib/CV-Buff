...
export const ResumeWorkbench = () => {
    ...
    const aiProviders = useAIConfigStore((s) => s.providers);
    const geminiProvider = aiProviders.find((p) => p.id === "gemini");
    const geminiApiKey = geminiProvider?.apiKey || "";
    const geminiModelId = geminiProvider?.selectedModel || geminiProvider?.defaultModel || "";
